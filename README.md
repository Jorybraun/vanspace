...
> **Do not build the full site until** the recommendation is approved and slice 0 in the implementation plan is accepted.
...
| `ops/sponsor-deck-outline.md` | **Private** deck spine (not on marketing site) |
| `ops/sponsor-value-props.md` | **Private** value props: Flagship $10k, Gold $7k… |
| `ops/budget.md` | Money + Flagship $10k |
| `ops/run-of-show-template.md` | Day-of clock |

---

## Brand snapshot

- **Palette:** cream `#F4F0E8` · ink `#1A1A1A` · mist `#8B8499` (single accent)
- **Devin blue `#317CFF`:** sponsor marks only
- **Signature:** Space Centre saucer in **pointillism** → click/scroll into **orbit graph**
- **Site IA:** [Cursor Codechella](https://www.cursorvictoria.com/)-shaped
- **Aesthetic north star:** [Kindolphin](https://ac-bu.info/kindolphin/)-style monochrome stipple

Assets:

- Space Centre hero ref: `brand/space-centre-hero-ref.png`
- Kindolphin ref: `brand/kindolphin-aesthetic-ref.png`
- Devin / Cognition marks: `brand/devin-assets/`
...
Slice 0 ships: brand board + static marketing shell + waitlist/tickets link + ops kit (already largely here).
